         ...
         this.getnexttoken = function () {
             ...
             switch (true) {
                 ...
                 case a === '[':                                                        // 배열 해당
                     ...
                     break;
                 case a === '/':   // comment
                     console.log("[%s]  [%s]  %s", a, this.nextchar, this.lines );
                     this.insertcomment();
...
// tp_taf  : traditional arrow function
jsparser.prototype.reconizetaf = function (){
    return ((this.backupline.indexOf('=>') !== -1)
         );
}

// tp_iif  : Immediately invoked function
jsparser.prototype.reconizeiif = function (){
...
// tp_aiif  : Anonymouse Immediately invoked function
jsparser.prototype.reconizeaiif = function (){
...
jsparser.prototype.inserttoken = function() {
    ...
    if (this.tokenarray.length != 0) {
        ...
        // tp_aiif  : Anonymouse Immediately invoked function
        /* ----------------------------------------------------- */
        } else if (this.reconizeaiif()) {
                   this.tokenarray.unshift('tp_aiif');


        /* ----------------------------------------------------- */
        // tp_iif  : Immediately invoked function
        /* ----------------------------------------------------- */
        } else if (this.reconizeiif()) {
                   this.tokenarray.unshift('tp_iif');
        ...
        // tp_taf  : traditional arrow function
        /* ----------------------------------------------------- */
        } else if (this.reconizetaf()) {
                   this.tokenarray.unshift('tp_taf');
