...
function rangestr(s, c1, c2){
    //
    if ((charcount(s, c1) !== 1) && (charcount(s, c2) !== 1)){
       throw "no range char";
    }
                 ...
                 case a === '$':                                                      // jquery
                     ...
                     if (charcnt === 2) {
                         ...
                         for(let i=0; i<arr.length; i++){
                             ...
                             s = s.indexOf(1, s.length-1);
                             i === 0 ? name = name +s: name = name + ',' +s
                         } // end for
                         this.arraytoken.push(this.linenumber);
                         this.arraytoken.push(typename);
                         this.arraytoken.push(name);
                         this.lines.substring(idx);
                     }  else { // end if
