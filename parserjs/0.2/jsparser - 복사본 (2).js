...
jsparser.prototype.recognizeaf = function (){
    return ((this.recognizecommonfs()) && (this.getnextchar('=') === '('));
}

jsparser.prototype.reconizetf = function (){
    return ((this.recognizecommonfs()) && (this.backupline.indexOf('=>') !== -1));
}
...
jsparser.prototype.inserttoken = function() {
    ...
    if (this.tokenarray.length != 0) {
        ...
        if (this.tokenarray[0] === 'function') {                 // general function ( function ab(){} )  [seq|function|ab]
        ...
        /* ----------------------------------------------------- */
        // tp_tf  : arrow(traditional) function
        /* ----------------------------------------------------- */
