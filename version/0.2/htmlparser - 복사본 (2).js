...
var Chromeparser = function (hj) {
         ...
         //this.fixedtags = makearray("html,head,title,dody,table");
         this.fixedtags =["html","head","title","dody","table"];
         var depthend = false;
         var bcontinue = false;
        ...
        */
        console.log("xxxx   ", this.fixedtags);
...
Chromeparser.prototype.checkfixedtag = function (str) {
         //console.log("", this.fixedtags);
         for(var i=0; i < this.fixedtags.length-1; i++) {
...
var PP = new Chromeparser("<html><body topmargin='0'></body></html>");
PP.parserunit();
