         ...
         this.getnexttoken = function () {
             ...
             switch (true) {
                 ...
                 case (a >= '0' && a <= '9') || a === '+': console.log("A = [%s]",a);
                     ...
                     break;
                 case a === '<':
                     console.log("updatetoken :  ", this.nexttoken, this.depth);
                 ...
                 case (a >= 'A' && a <= 'Z') || (a >= 'a' && a <= 'z') || a === '_' || a === '@' || a === '-':  // 문자
                     ...
                     if (depthend && !bcontinue) {
                        //if (btag) { console.log("======================== = [%s]",a, this.nexttoken)}
                        //else {}
                        if (btag) {
                          //console.log("======================== = [%s]",a, this.nexttoken);
                          this.skiptoken();
                        } else {
                          //console.log("xxxxxxxxxxxxxxxxxxxxxxxxx = [%s]",a, this.nexttoken);
                          this.addone();
                        }
                     } else {
...
//var PP = new Chromeparser("<html><head><script type='text/javascript' src='../../fckconfig.js'></script></head><body></body></html>");

var PP = new Chromeparser("<html><head><title>abcd -efg</title></head><body>var oFCKeditor = new FCKeditor( 'FCKeditor1' ) ;</body></html>");
