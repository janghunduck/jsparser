         ...
         this.getnexttoken = function () {
             ...
             switch (true) {
                 ...
                 case a === ' ':
                     ...
                     this.varrule(false);                                          // (var x공백;)  (var x공백= 9;) 두 번째 공백이 들어올 경우 이것은 true 이다.
                 ...
                 case a === '=':
                    ...
                    if (this.keywords.val) { this.varrule2(); };                   // var   x=9;  = 이후 skipstrings
...
var pj = new Parjs("var   x=9; var y ;var z, m;");
